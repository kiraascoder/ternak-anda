        ...
        @elseif($userRole === 'Admin')
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.userView') }}"
                    class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.userView') ? 'bg-green-600 text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    <svg class="flex-shrink-0 h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="space-y-1 pt-4">
                <p class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Manajemen Informasi</p>

                <a href="{{ route('admin.informasi') }}"
                    class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.informasi') ? 'bg-green-600 text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    <svg class="flex-shrink-0 h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.pakan') }}"
                    class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.pakan') ? 'bg-green-600 text-white' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }}">
                    <svg class="flex-shrink-0 h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
