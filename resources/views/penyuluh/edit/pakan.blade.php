...
<body>
    ...
    <form action="{{ route('pakan.edit', $pakan->idRekomendasi) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="date" name="tanggalRekomendasi" id="tanggalRekomendasi" required
                value="{{ $pakan->tanggalRekomendasi }}">
        </div>

        <div>
            <label for="jenisPakan">Jenis Pakan:</label><br>
            <input type="text" name="jenisPakan" id="jenisPakan" required value="{{ $pakan->jenisPakan }}">
        </div>

        <div>
            <label for="jumlah">Jumlah</label><br>
            <input type="number" name="jumlah" id="jumlah" required value="{{ $pakan->jumlah }}">
        </div>
        <div>
            <label for="saran">Saran</label><br>
            <input type="text" name="saran" id="saran" required value="{{ $pakan->saran }}">
        </div>
