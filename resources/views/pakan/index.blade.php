...
@section('title', 'Informasi Pakan Ternak')
    ...
    <section class="py-12 bg-gray-50 pt-32">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Jelajahi Informasi Pakan</h2>
            ...
            <div class="mb-8">
                <div class="flex flex-col lg:flex-row gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        <div class="relative">
                            <input type="text" id="searchInput" placeholder="Cari informasi pakan..."
            ...
            <div id="gridView" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada informasi pakan</h3>
                        <p class="text-gray-500">Belum ada informasi pakan yang tersedia saat ini.</p>
                    </div>
                @endforelse
            </div>
